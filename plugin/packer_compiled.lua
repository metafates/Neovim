...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-fugitive"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/vim-fugitive",
  ...
  ["vim-signature"] = {
    loaded = true,
    path = "/Users/lain/.local/share/nvim/site/pack/packer/start/vim-signature",
